...
public class ProductDao {
	...
	public List<Product> findHotProductList() throws SQLException {
		...
		String sql = "select * from product where is_hot=? and pflag=0 limit ?,?";
	...
	public void updateOrderAdrr(Order order) throws SQLException {
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		String sql = "update orders set address=?,name=?,telephone=? payid=? where oid=?";
		runner.update(sql, order.getAddress(),order.getName(),order.getTelephone(),order.getPayid(),order.getOid());
	}
	...
	public void updateProductState(String pid) throws SQLException {
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
